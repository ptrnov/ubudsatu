...
class Pembukuan extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'CHILD' => 'Child',
            'SRC' => 'RW/RT/1234',
            'SRC_DSC_REF' => 'KODE PEMBUKUAN',
            'SRC_DSC' => 'ASAL PEMASUKAN/PENGELUARAN',
            'SRC_DSC_QTY' => 'JUMLAH ASAL PEMASUKAN/PENGELUARAN',
            'SRC_DSC_PRICE' => 'NOMINAL ASAL PEMASUKAN/PENGELUARAN',
            'SRC_DSC_DETAIL' => 'DETAIL PEMASUKAN|PEMBELIAN|PENGELUARAN',
