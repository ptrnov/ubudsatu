...
use crm\salespromo\models\Penjualan;

/**
 * PenjualanSearch represents the model behind the search form about `crm\salespromo\models\Penjualan`.
 */
class PenjualanSearch extends Penjualan
{
    ...
    {
        return [
            [['ID', 'STOCK_SOLD_OUT', 'PRODAK_LINE', 'STATUS'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'ID' => $this->ID,
            'WAKTU' => $this->WAKTU,
            'STOCK_SOLD_OUT' => $this->STOCK_SOLD_OUT,
