...
/**
 * This is the model class for table "{{%sp004}}".
 *
 * @property integer $ID
 ...
 */
class Stock_promo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['STOCK_PROMO', 'PRODAK_LINE', 'STATUS'], 'integer'],
            [['UPDATED_BY'], 'required'],
