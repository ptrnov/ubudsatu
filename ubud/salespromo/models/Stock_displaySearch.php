...
/**
 * Stock_displaySearch represents the model behind the search form about `crm\salespromo\models\Stock_display`.
 */
class Stock_displaySearch extends Stock_display
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ID', 'STOCK_DISPLAY', 'PRODAK_LINE', 'STATUS'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'ID' => $this->ID,
            'WAKTU' => $this->WAKTU,
            'STOCK_DISPLAY' => $this->STOCK_DISPLAY,
