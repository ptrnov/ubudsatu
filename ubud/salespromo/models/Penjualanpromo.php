...
/**
 * This is the model class for table "{{%sp002}}".
 *
 * @property integer $ID
 ...
 * @property integer $STOCK_PROMO_OUT
 ...
 */
class Penjualanpromo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['STOCK_PROMO_OUT', 'PRODAK_LINE', 'STATUS'], 'integer'],
            [['UPDATED_BY'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'KD_BARANG' => 'Kd  Barang',
            'NM_BARANG' => 'Nm  Barang',
            'STOCK_PROMO_OUT' => 'Stock  Promo  Out',
